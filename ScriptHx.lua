...
function ZorVexStatus:CreateStatsUI()
    self.StatsTab = self.Window:Tab({Title = "Anti AFK", Icon = "clock"})
    self.StatsTab:Section({Title = "Status Anti AFK", Icon = "shield"})
    
    self.TimerLabel = self.StatsTab:Paragraph({Title = "MODE AFK", Desc = "Menghitung waktu..."})
end
...
function ZorVexStatus:RefreshTimer()
    local fsB, fsT = 18, 28
    ...
    pcall(function()
        ...
        self.TimerLabel:SetTitle('<font size="'..fsT..'"><b>MODE AFK ACTIVE</b></font>')
